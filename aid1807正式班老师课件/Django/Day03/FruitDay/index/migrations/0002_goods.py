    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(upload_to='staitc/upload/goods', verbose_name='商品图片')),
                ('isActive', models.BooleanField(default=True, verbose_name='布尔')),
                ('GoodType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='index.GoodType', verbose_name='商品类型')),
            ],
            options={
                'verbose_name': '商品',
                'db_table': 'goods',
