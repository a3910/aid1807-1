...
Private Sub Command1_Click()
    ...
    Set myrecordset = Mydb.OpenRecordset("select * from outlib where 出库日期>=#" & DTPicker1.Value & "# and 出库日期<= #" & DTPicker2.Value & "# and 出库类型='销售'")
    price = 0
