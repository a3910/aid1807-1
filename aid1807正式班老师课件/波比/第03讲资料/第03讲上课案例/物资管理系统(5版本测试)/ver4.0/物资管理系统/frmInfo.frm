...
Private Sub Command1_Click()
    ...
    Set MSFlexGrid1 = InAdd.MSFlexGrid1
    ...
    InAdd.cmdDelRecord.Enabled = True
...
Private Sub Form_Load()
    ...
    Set myrecordset = Mydb.OpenRecordset("select * from goods")
...
Private Sub MSFlexGrid2_DblClick()
    ...
    If Combo1.Text <> "" Then
        Set myrecordset = Mydb.OpenRecordset("select * from Goods where Goodsid='" & Trim(MSFlexGrid2.Text) & "'")
